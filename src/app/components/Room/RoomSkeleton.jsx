...
export default function RoomSkeleton({ skeletonLength }) {
  return (
    <article className='grid grid-cols-1 gap-4 px-4 mx-4 mb-10 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 '>
      {
        Array.from({ length: skeletonLength }, (_, index) => <Skeleton key={index} />)
      }
    </article>
  )
}
